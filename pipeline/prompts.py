...
Твоя задача - написать вопрос, на который данный текст отвечает лучше всего.
ВАЖНО: вопрос должен быть простой, но не слишком короткий. Вопрос не должен быть слишком конкретным
