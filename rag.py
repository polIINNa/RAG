...
if __name__ == '__main__':
    for file_name in files:
        ...
        for question in questions_list:
            ...
            with open('db/parents.json', 'r', encoding='utf-8') as f:
                parents = json.load(f)
        ...
        print('ЗАПИСЬ В ФАЙЛ')
        with open(f'C:/Users/ADM/OneDrive/Desktop/RAG/summarize_query_rewriting/no_doc_info/{program_name}.json', 'w', encoding="utf-8") as f:
