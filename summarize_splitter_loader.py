...
if __name__ == '__main__':
    ...
    for file_name in files:
        ...
        file_parents = []
        with open(f'C:/Users/ADM/OneDrive/Desktop/RAG_gospodderzka/summarize_data/chunks/{file_name.split(".pdf")[0]}.json', 'r', encoding='utf-8') as f:
            chunks = json.load(f)
        for chunk in chunks:
            parent = {
                      'id': chunk['parent_id'],
    ...
    with open('db/parents.json', 'w', encoding='utf-8') as f:
